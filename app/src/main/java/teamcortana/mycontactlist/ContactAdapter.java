...
/**
 * Created by zubairrauf on 4/25/17.
 */
...
public class ContactAdapter extends ArrayAdapter<Contact> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            TextView details = (TextView) v.findViewById(R.id.textDetails);
            Button b = (Button) v.findViewById(R.id.buttonDeleteContact);

            contactName.setText(contact.getContactName());
            contactNumber.setText("Phone: "+contact.getPhoneNumber()+" Cell: "+contact.getCellNumber());
            details.setText("City: "+contact.getCity()+" State: "+contact.getState()+" Zip: "+contact.getZipCode());
